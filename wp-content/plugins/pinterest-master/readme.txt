...
Pinterest is a great booming social network that lets you organize and share all the beautiful things you find on the web, people use pinboards to plan their events like weddings, decorate their homes, organize their favourite recipes, etc. Pinterest Master adds the follow me on pinterest button, pin it button, show pinterest profile and show pinterest board to your website making easier for users and visitors to share "pin it" the page they are reading or follow your pinterest profile.
...
* [About Shortcode Framework v5](http://wordpress.techgasp.com/techgasp-wordpress-framework-v5/)
...
= 2.3 =
* Added admin_notices
* Fixed blockquotes issues

= 2.2 =
* Fixing a few typos

= 2.1 =
* Redefining plugin Nick
