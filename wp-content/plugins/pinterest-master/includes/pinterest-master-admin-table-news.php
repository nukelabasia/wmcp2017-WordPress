...
class pinterest_master_admin_table_news extends WP_List_Table {
	/**
...
<table class="widefat" cellspacing="0">
	<thead>
		<tr>
			<th><h2><img src="<?php echo plugins_url('images/techgasp-minilogo-16.png', dirname(__FILE__)); ?>" style="float:left; height:18px; vertical-align:middle;" /><?php _e('&nbsp;Latest News', 'pinterest_master'); ?></h2></th>
		</tr>
	</thead>
